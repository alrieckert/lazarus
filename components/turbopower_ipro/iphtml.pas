  ...
  InitScrollProcs;
{
  ...
  Revision 1.5  2003/02/16 19:55:04  mkaemmerer
  - speed up for ParmList and FindAttribute

  Revision 1.4  2003/02/16 17:37:45  mkaemmerer
  - Speed up for ParseConstant
    (from: adem baba <adembaba@users.sourceforge.net>)

  Revision 1.3  2003/01/19 21:57:31  mkaemmerer
  - added Id, Log and Contributor
