...
uses
  LMessages, Types, Classes,  LCLType, LCLVersion, LazUTF8;
...
{$i opkman_delphicompat.inc}

initialization
  FTimerList := TTimerList.Create;
  {$ifdef DEBUG_DELPHICOMPAT}
  Logger := TLCLLogger.Create;
  Logger.Channels.Add(TFileChannel.Create('opkman_delphicompat.log'));
