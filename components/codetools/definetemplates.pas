...
type
  ...
  public
    ...
    procedure MarkAllNonAutoNonProjSpecNodes;
    procedure MarkAllNonAutoProjSpecNodes;
    procedure Unbind;
    procedure Clear;
    constructor Create;
...
begin
  ...
  while ANode<>nil do begin
    if ANode.FirstChild<>nil then begin
      ...
      FChildFlags:=FChildFlags+ANode.FirstChild.FChildFlags
                              +ANode.FirstChild.Flags;
    end;
    ANode:=ANode.Next;
  end;
end;
...
procedure TDefineTemplate.MarkAllNonAutoNonProjSpecNodes;
...
begin
  ...
  while ANode<>nil do begin
    ...
    if ANode.FirstChild<>nil then
      ANode.FirstChild.MarkAllNonAutoNonProjSpecNodes;
    ANode:=ANode.Next;
  end;
end;

procedure TDefineTemplate.MarkAllNonAutoProjSpecNodes;
// mark every node, that itself and its parents are not auto generated and
...
begin
  ...
  while ANode<>nil do begin
    ...
    if ANode.FirstChild<>nil then
      ANode.FirstChild.MarkAllNonAutoProjSpecNodes;
    ANode:=ANode.Next;
  end;
end;
...
begin
  ...
  case Policy of
    dtspProjectSpecific:
      begin
        FFirstDefineTemplate.MarkAllNonAutoProjSpecNodes;
        FFirstDefineTemplate.SaveToXMLConfig(XMLConfig,Path,true,true);
      end;

    dtspGlobals:
      begin
        FFirstDefineTemplate.MarkAllNonAutoNonProjSpecNodes;
        FFirstDefineTemplate.SaveToXMLConfig(XMLConfig,Path,true,true);
      end;
  else
