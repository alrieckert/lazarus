...
begin
  ...
  begin
    ...
    if ATo='koi8r' then begin Result:=cp1251ToKoi8r(utf2cp1251(s));exit;end;
  end;
  if (ATo='utf8') then
  begin
    if AFrom='cp1251' then begin Result:=Cp1251toUTF(s);exit;end;
    if AFrom='koi8r' then begin Result:=Cp1251toUTF(Koi8rToCP1251(s));exit;end;
  end;
