...
override TARGET_UNITS+=buttons clipbrd clistbox comctrls controls dialogs dynhasharray extctrls filectrl forms graphics imglist interfacebase lazqueue lcllinux lmessages lresources menus messages registry spin stdctrls toolwin utrace vclglobals
override DIST_ZIPNAME=lazarus.lcl.$(ZIPSUFFIX)
override COMPILER_OPTIONS+=-gl
override COMPILER_INCLUDEDIR+=./include
override COMPILER_UNITDIR+=$(COMPILER_UNITTARGETDIR) ./interfaces/abstract
...
interfaces:
	$(MAKE) -C interfaces all
.PHONY: interfaces_all interfaces_debug interfaces_smart interfaces_examples interfaces_shared interfaces_install interfaces_sourceinstall interfaces_exampleinstall interfaces_distinstall interfaces_zipinstall interfaces_zipsourceinstall interfaces_zipexampleinstall interfaces_zipdistinstall interfaces_clean interfaces_distclean interfaces_cleanall interfaces_info interfaces
endif
debug: fpc_debug
smart: fpc_smart
