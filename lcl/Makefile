...
override CLEAN_FILES+=$(wildcard units/*$(OEXT)) $(wildcard units/*$(PPUEXT))
...
.PHONY: package_rtl package_paszlib package_inet package_fcl package_mysql package_ibase package_x11 package_opengl package_gtk
ifndef NOCPUDEF
