...
override DIROBJECTS+=$(wildcard interfaces)
...
override NEEDUNITDIR=./units ./interfaces/units ./interfaces/gtk
...
OBJECTDIRINTERFACES=1

# Dir interfaces

ifdef OBJECTDIRINTERFACES
.PHONY:  interfaces_all interfaces_debug interfaces_examples interfaces_test interfaces_smart interfaces_shared interfaces_showinstall interfaces_install interfaces_sourceinstall interfaces_exampleinstall interfaces_zipinstall interfaces_zipsourceinstall interfaces_zipexampleinstall interfaces_clean interfaces_distclean interfaces_cleanall interfaces_require interfaces_info
...
interfaces_showinstall:
	$(MAKE) -C interfaces showinstall
...
all: cleartarget interfaces_all allunits$(EXEEXT)
	-$(DEL) allunits$(EXEEXT)
