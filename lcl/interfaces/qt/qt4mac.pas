...
function QCursor_handle(handle: QCursorH): QtHANDLE; cdecl; external QtIntf name 'QCursor_handle';
...
function QRegion_handle(handle: QRegionH): RgnHandle; overload; cdecl; external QtIntf name 'QRegion_handle';
function QRegion_handle(handle: QRegionH; require_rgn: Boolean): RgnHandle; overload; cdecl; external QtIntf name 'QRegion_handle2';
...
function QFont_handle(handle: QFontH): QtHANDLE; cdecl; external QtIntf name 'QFont_handle';
