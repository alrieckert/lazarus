...
type
  ...
  private
    ...
    procedure setPageSize(const AValue: QPagedPaintDevicePageSize);
    function getPageSize: QPagedPaintDevicePageSize;
  ...
  public
    ...
    property PageSize: QPagedPaintDevicePageSize read getPageSize write setPageSize;
...
procedure TQtPrinter.setPageSize(const AValue: QPagedPaintDevicePageSize);
begin
  QPrinter_setPaperSize(FHandle, AValue);
end;

function TQtPrinter.getPageSize: QPagedPaintDevicePageSize;
begin
