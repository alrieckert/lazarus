...
override COMPILER_UNITDIR+=designer debugger
...
override REQUIRE_PACKAGES=rtl lcl synedit codetools
ifeq ($(OS_TARGET),linux)
...
REQUIRE_PACKAGES_SYNEDIT=1
REQUIRE_PACKAGES_CODETOOLS=1
...
ifdef REQUIRE_PACKAGES_SYNEDIT
PACKAGEDIR_SYNEDIT:=$(firstword $(subst /Makefile.fpc,,$(strip $(wildcard $(addsuffix /synedit/Makefile.fpc,$(PACKAGESDIR))))))
ifneq ($(PACKAGEDIR_SYNEDIT),)
ifneq ($(wildcard $(PACKAGEDIR_SYNEDIT)/$(OS_TARGET)),)
UNITDIR_SYNEDIT=$(PACKAGEDIR_SYNEDIT)/$(OS_TARGET)
else
UNITDIR_SYNEDIT=$(PACKAGEDIR_SYNEDIT)
endif
else
PACKAGEDIR_SYNEDIT=
UNITDIR_SYNEDIT:=$(subst /Package.fpc,,$(strip $(wildcard $(addsuffix /synedit/Package.fpc,$(UNITSDIR)))))
ifneq ($(UNITDIR_SYNEDIT),)
UNITDIR_SYNEDIT:=$(firstword $(UNITDIR_SYNEDIT))
else
UNITDIR_SYNEDIT=
endif
endif
ifdef UNITDIR_SYNEDIT
override COMPILER_UNITDIR+=$(UNITDIR_SYNEDIT)
endif
endif
ifdef REQUIRE_PACKAGES_CODETOOLS
PACKAGEDIR_CODETOOLS:=$(firstword $(subst /Makefile.fpc,,$(strip $(wildcard $(addsuffix /codetools/Makefile.fpc,$(PACKAGESDIR))))))
ifneq ($(PACKAGEDIR_CODETOOLS),)
ifneq ($(wildcard $(PACKAGEDIR_CODETOOLS)/$(OS_TARGET)),)
UNITDIR_CODETOOLS=$(PACKAGEDIR_CODETOOLS)/$(OS_TARGET)
else
UNITDIR_CODETOOLS=$(PACKAGEDIR_CODETOOLS)
endif
else
PACKAGEDIR_CODETOOLS=
UNITDIR_CODETOOLS:=$(subst /Package.fpc,,$(strip $(wildcard $(addsuffix /codetools/Package.fpc,$(UNITSDIR)))))
ifneq ($(UNITDIR_CODETOOLS),)
UNITDIR_CODETOOLS:=$(firstword $(UNITDIR_CODETOOLS))
else
UNITDIR_CODETOOLS=
endif
endif
ifdef UNITDIR_CODETOOLS
override COMPILER_UNITDIR+=$(UNITDIR_CODETOOLS)
endif
endif
...
.PHONY: debug smart release shared install sourceinstall exampleinstall distinstall zipinstall zipsourceinstall zipexampleinstall zipdistinstall distclean cleanall info makefiles
