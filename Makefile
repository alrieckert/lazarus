...
override NEEDUNITDIR=. lcl/units lcl lcl/interfaces/units lcl/interfaces/gtk components/$(THE_EDIT) ./designer
override NEEDINCDIR=. ./include ./include/$(OS_TARGET) lcl/include
ifndef TARGETDIR
TARGETDIR=.
endif
