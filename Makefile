#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2013/04/22]
#
default: all
...
install:
	...
	$(COPYTREE) components docs doceditor examples lcl test install tools $(LAZARUS_INSTALL_DIR)
