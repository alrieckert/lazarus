...
.PHONY: package_rtl package_paszlib package_inet package_fcl package_gtk package_regexpr package_mysql package_ibase package_x11 package_opengl
...
info: fpc_info
.PHONY: debug smart shared install sourceinstall exampleinstall distinstall zipinstall zipsourceinstall zipexampleinstall zipdistinstall clean distclean cleanall info
